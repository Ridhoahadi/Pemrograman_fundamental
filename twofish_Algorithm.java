...
public final class twofish_Algorithm {
    ...
    static final int BLOCK_SIZE = 16; //byte dalam blok data
    private static final int ROUNDS = 16;

    //indeks array dari subkey
    ...
    //Memperbaiki S-box permutasi 8x8
    ...
    /**
     * Tentukan permutasi p0/p1 tetap yang digunakan dalam pencarian kunci S-box.
     * Dengan mengubah definisi konstan berikut, S-box akan
     * secara otomatis diganti di mesin Twofish.
     */
    ...
    public static synchronized Object makeKey(byte[] k) {
        ...
        // bagi kunci menjadi elemen 32-bit genap dan ganjil
        int i, j, offset = 0;
        ...
        // menghitung subelemen kunci untuk PHT.
        int q, A, B;
